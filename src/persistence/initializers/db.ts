...
export class DbDataInitializer implements IDataInitializer {
  ...
  async initData(): Promise<number> {
    ...
    await this.unitOfWork.guides.add({
      ...
      description:
        'The guide of guides will guide you through the history of Linz and its beautifullness',
      chronological: false,
      rating: 0,
      numOfRatings: 0,
    });
    ...
    await this.unitOfWork.guides.add({
      id: '',
      name: 'A great story for a great time',
      user: 'thelegend27',
      imageLink: '/img/astrid.png',
      tags: ['history', 'irrelevant'],
    ...
    await this.unitOfWork.guides.add({
      ...
      tags: ['culture'],
      description:
        'A nonsense guide with nonsense content and nosense description',
      chronological: false,
      rating: 0,
      numOfRatings: 0,
    });
    ...
    const ratings: IRating[] = [
      {
        userId: '1',
        guideId: (
          await this.unitOfWork.guides.getGuidesByName('Callcenter access 3000')
        )[0].id,
        rating: 3,
      },
      {
      ...
      },
      {
        userId: '3',
        guideId: (
          await this.unitOfWork.guides.getGuidesByName('A Guide with name 2')
        )[0].id,
        rating: 5,
      },
      {
      ...
      },
      {
        userId: '2',
        guideId: (
          await this.unitOfWork.guides.getGuidesByName('History of Linz')
        )[0].id,
        rating: 3,
      },
      {
      ...
      },
      {
        userId: '1',
        guideId: (
          await this.unitOfWork.guides.getGuidesByName(
